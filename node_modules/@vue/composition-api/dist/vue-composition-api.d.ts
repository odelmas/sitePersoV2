...
declare type ObjectEmitsOptions$1 = Record<string, ((...args: any[]) => any) | null>;
declare type EmitsOptions$1 = ObjectEmitsOptions$1 | string[];
declare type EmitFn<Options = ObjectEmitsOptions$1, Event extends keyof Options = keyof Options> = Options extends Array<infer V> ? (event: V, ...args: any[]) => void : {} extends Options ? (event: string, ...args: any[]) => void : UnionToIntersection<{
    [key in Event]: Options[key] extends (...args: infer Args) => any ? (event: key, ...args: Args) => void : (event: key, ...args: any[]) => void;
}[Event]>;
declare type Slots = Readonly<InternalSlots>;
interface SetupContext<E = EmitsOptions$1> {
    attrs: Data;
    slots: Slots;
    emit: EmitFn<E>;
    /**
...
B = {}, // raw bindings returned from setup()
D = {}, // return from data()
C extends ComputedOptions = {}, M extends MethodOptions = {}, E extends EmitsOptions$1 = {}, PublicProps = P, Defaults = {}, MakeDefaultsOptional extends boolean = false> = {
...
declare type ComponentOptionsWithoutProps<Props = {}, RawBindings = Data, D = Data, C extends ComputedOptions = {}, M extends MethodOptions = {}> = ComponentOptionsBase<Props, D, C, M> & {
    props?: undefined;
    emits?: (EmitsOptions | string[]) & ThisType<void>;
    setup?: SetupFunction<Props, RawBindings>;
} & ThisType<ComponentRenderProxy<Props, RawBindings, D, C, M>>;
...
declare function defineComponent<RawBindings, D = Data, C extends ComputedOptions = {}, M extends MethodOptions = {}>(options: ComponentOptionsWithoutProps<{}, RawBindings, D, C, M>): VueProxy<{}, RawBindings, D, C, M>;
